...
<body>
	...
	<table width="100%">
		<tr>
			<td width="50%">
				<center><hr></center>
				<center>Fabíolo Moraes Amaral</center>
				<center>Diretor Geral</center>
			</td>
			<td width="50%">
				<center><hr></center>
				<center>{{$ata->fornecedor->fornecedorable->representante ?? ''}}</center>
				<center>Representante Legal da Empresa</center>
			</td>
		</tr>
	</table>
</body>
