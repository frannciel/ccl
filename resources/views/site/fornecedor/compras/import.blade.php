...
<div class="flex">
	<nav aria-label="breadcrumb">
		<ol class="breadcrumb mb-0">
			...
			<li class="breadcrumb-item"><a href="{{route('requisicao.index')}}">Fornecedores</a></li>
			<li class="breadcrumb-item active" aria-current="page">Importar</li>
		</ol>
	</nav>
	<h1 Class="page-header page-title">Importar Fornecedores</h1>
</div>
...
<div class="panel panel-default mt-3">
	<div class="panel-heading"><label class="custom-file-label" for="texto">TEXTO - Inserir a planilha em formato texto com colunas separadas por "&".</label></div>
	<div class="panel-body">
		{{ Form::open(['route' => 'fornecedor.importarTexto', 'method' => 'post', 'class' => 'form-padrao'])}}
			<div class="row centered">
				@include('form.textarea', [
				'input' => 'texto', 
				'largura' => '6',
				'attributes' => ['id' => 'texto', 'required' => '', 'value' => '{{ old($input) }}', 'rows' => 2]])
			</div>
			<div class="row centered">
				@include('form.submit',	[
				'input' => 'Enviar', 
...
<div class="panel panel-default mt-3">
	<div class="panel-heading"><label far="arquivo" class="form-control-label" for="arquivo">EXCEL - Selecione o arquivo Excel com extensão XLSX, XML e XLS </label></div>
	<div class="panel-body">
		{{ Form::open(['route' => 'fornecedor.importarExcel', 'method'=>'post', 'class'=>'form-padrao', 'enctype'=>'multipart/form-data'])}}
			<div class="row centered">
				<div class="col-md-4">
...
<div class="row centered mt-3">
	<div class="col-md-6">
		<a href="{{route('fornecedor.index')}}" class="btn btn-primary btn-block" type="button">Voltar</a>
	</div><!-- / col-md-3  -->
</div>
