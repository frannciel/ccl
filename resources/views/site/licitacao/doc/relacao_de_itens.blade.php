...
<div class="panel panel-default mt-4">
      ...
      <div class="row">
         <div class="col-md-12">
            <h3>
               ...
               <a href="{{route('licitacao.show', $licitacao->uuid)}}">Licitação n° {{$licitacao->ordem ?? '' }}</a>
            </h3>
   ...
   @if ($licitacao->itens()->exists()) <!-- Verifica se a licitação já contpem itens -->
      ...
      <div class="row mt-1">
         <div class="col-md-3 col-md-offset-1">
            <a class="btn btn-primary btn-block" type="button" href="{{route('licitacao.show', $licitacao->uuid)}}" >Voltar</a>
         </div>
         <div class="col-md-3">
            <button class='btn btn-block btn-success' data-clipboard-action='copy' data-clipboard-target='#relacao'>Copiar </button>
         </div>
         <div class="col-md-3">
            <a class="btn btn-default btn-block" type="button" href="{{route('licitacao.relacaoDeItemPdf', $licitacao->uuid)}}" role="button" target="_black">
               Exportar PDF
            </a> 
         </div>
      </div>
   @else   
      ...
      <div class="row mt-1">
         <div class="col-md-3 col-md-offset-1">
            <a class="btn btn-primary btn-block" type="button" href="{{url('licitacao.showe', $licitacao->uuid)}}" >Voltar</a>
         </div>
      </div>
   @endif
@endsection
