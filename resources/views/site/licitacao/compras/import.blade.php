...
{{ Form::open(['route' => ['item.importarTexto', $licitacao->uuid], 'method' => 'post', 'class' => 'form-padrao'])}}
	<div class="row">
		@include('form.textarea', [
		'input' => 'texto', 
		'label' => 'PARTICIPANTES - Inserir a planilha em formato texto com colunas separadas por "&".', 
		'largura' => '8',
...
{{ Form::open(['route' => ['cotacao.importarTexto', $licitacao->uuid], 'method' => 'post', 'class' => 'form-padrao'])}}
	<div class="row mt-4 row-center">
		@include('form.textarea', [
		'input' => 'texto', 
		'label' => 'RESULTADO POR FORNECEDOR - Inserir a planilha em formato texto com colunas separadas por "&".', 
		'largura' => '8',
		'attributes' => ['id' => 'texto', 'value' => '{{ old($input) }}', 'rows' => 3 ]
		])
	</div>
