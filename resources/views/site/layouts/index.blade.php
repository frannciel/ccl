            ...
            <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a data-route="{{route('logout')}}" id="logout" disabled="" aria-disabled="true"><i class="fa fa-sign-out fa-fw"></i> Logout</a></li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
                <!-- /.dropdown -->
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{route('requisicao.create')}}">Nova</a>
                                </li>
                                <li>
                                    <a href="{{route('requisicao.index')}}">Buscar</a>
                                </li>
                            </ul><!-- /.nav-second-level -->
                        </li>
                        @if(Auth::user()->isAc == true)
                        <li>
                            <a href="#"><i class="fa fa-wrench fa-fw"></i>Licitações<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{route('pregao.create')}}">Novo Pregão</a>
                                </li>
                                <li>
                                    <a href="{{route('licitacao.index')}}">Buscar</a>
                                </li>
                                <li>
                                    <a href="{{route('item.fornecedorCreate')}}">Atribuir Fornecedor</a>
                                </li>
                                <li>
                                    <a href="#">Documentos</a>
                                </li>
                       ...
                       @endif
                        <li>
                            <a href="#"><i class="fa fa-group fa-fw"></i>Fornecedores<span class="fa arrow"></a>
                            <ul class="nav nav-second-level">
                                <li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-group fa-fw"></i>Contratações<span class="fa arrow"></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="#">Novo</a>
                                </li>
