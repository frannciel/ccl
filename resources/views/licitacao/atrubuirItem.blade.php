	...
	<div class="panel-body">
		<table class="table table-hover tablesorter">
			...
			<tbody>
				...
				<tr onclick="location.href ='{{route('licitacaoAtribuirItemShow', [$licitacao->uuid, $requisicoes->uuid])}}'; target='_blank';" style="cursor: hand;">
					<td class="center">{{$requisicoes->ordem}}</td>
					<td>{{$requisicoes->descricao}}</td>
					<td class="center">{{$requisicoes->requisitante->sigla}}</td>
					<td class="center">
						<a type="button"  href="{{url('licitacao/remover/requisicao', [$licitacao->uuid, $requisicoes->uuid])}}" class="btn btn-danger btn-sm"><i class="glyphicon glyphicon-trash"></i></a>
					</td>
				</tr>
				@empty
		...
		<div class="row mt-2">								
			...
			<div class="col-md-3">
				<a type="button" id="buscarItem" data-route="{{route('licitacao')}}" data-licitacao="{{$licitacao->uuid}}" class="btn btn-success btn-block"><i class="fa fa-search"></i><b>&emsp;Buscar Itens</b></a>
			</div><!-- / col-md-3  -->
...
<div class="row row-fluid">
	...
	<div class="col-md-3 mt-2">
		<button type="button" class="btn btn-success btn-block" data-toggle="modal" data-target="#atribuirItemModal">Atribuir</button>
	</div><!-- / col-md-3  -->

	<div class="col-md-3 mt-2">
		<button type="button" class="btn btn-warning btn-block" data-toggle="modal" data-target="#removerItemModal">Remover</button>
	</div><!-- / col-md-3  -->
</div><!-- / row -->
	...
	<div class="panel-heading">
		<div class="row">
			<div class="col-md-12">
				<h3>
					<span class="glyphicon glyphicon-link" aria-hidden="true"></span>
					<a href="{{route('licitacao', [$licitacao->uuid])}}">Requisição n° {{$requisicao->ordem ?? '' }}</a>
				</h3>
					...
					<tbody>
						...
						<tr>
							...
							<td class=" center">
								...
								@endif
								<!--<a type="button"  href="{{url('licitacao/remover/requisicao', ['requisicao' => $requisicao->uuid, 'licitacao' => $licitacao->uuid])}}" class="btn btn-danger btn-circle btn-sm">
							...
							<div class="row">
								...
								<div class="col-md-10">
									<h5>
										...
										<p> - Você poderá atrbuir estes itens novamente.</p>
										<p> - Remover atruição de itens mesclado irá desfazer a mescla desses itens.</p>
									</h5>
								</div><!-- / col-md-10 -->	
							</div><!-- / row -->
						</div><!-- /.modal-body -->
